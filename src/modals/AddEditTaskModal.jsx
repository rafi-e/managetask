    ...
    >
      ...
      >
        ...
        <div className="mt-8 flex flex-col space-y-3">
          ...
          <button
            className="flex w-full items-center justify-center py-3 dark:text-[#635fc7] dark:bg-white  text-white bg-[#635fc7] rounded-full "
            onClick={() => {
              setSubtasks((state) => [
                ...state,
                { title: "", isCompleted: false, id: uuidv4() },
          ...
          >
            <FaPlus size={15} className="mx-2" /> Add New Subtask
          </button>
        </div>
