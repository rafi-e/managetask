    ...
    >
      ...
      >
        ...
        <div className="mt-8 flex flex-col space-y-3">
          ...
          <div>
            <button
              className="flex w-full items-center justify-center hover:opacity-70 dark:text-[#635fc7] dark:bg-white  text-white bg-[#635fc7] py-2 rounded-full "
              onClick={() => {
                setNewColumns((state) => [
                  ...state,
            ...
            >
              <FaPlus size={15} className="mx-2" /> Add New Column
            </button>
            <button
              onClick={() => {
